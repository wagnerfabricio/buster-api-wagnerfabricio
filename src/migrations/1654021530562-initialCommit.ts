...
export class initialCommit1654021530562 implements MigrationInterface {
    name = 'initialCommit1654021530562'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "cart" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "paid" boolean NOT NULL DEFAULT false, "total" double precision NOT NULL DEFAULT '0', "userId" uuid NOT NULL, CONSTRAINT "REL_756f53ab9466eb52a52619ee01" UNIQUE ("userId"), CONSTRAINT "PK_c524ec48751b9b5bcfbf6e59be7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "cart_dvd" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "quantity" integer NOT NULL, "subtotal" double precision NOT NULL DEFAULT '0', "cartId" uuid NOT NULL, "dvdId" uuid NOT NULL, CONSTRAINT "PK_b364c310aefb1f56d5e63f052e8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "dvd" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "duration" character varying NOT NULL, CONSTRAINT "UQ_378ec7a5f866f33ebfdef5ae2a4" UNIQUE ("name"), CONSTRAINT "PK_1a7f37c43aab7c9a335ee666451" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "cart_dvd" ADD CONSTRAINT "FK_fbcbf6b7d97c3377a7a0e3e368b" FOREIGN KEY ("dvdId") REFERENCES "dvd"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "cart_dvd" DROP CONSTRAINT "FK_fbcbf6b7d97c3377a7a0e3e368b"`);
