...
export class addCascadeDeletion51653832246307 implements MigrationInterface {
    name = 'addCascadeDeletion51653832246307'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "dvd" DROP CONSTRAINT "FK_a68c996998e86e22dc2580918c3"`);
        await queryRunner.query(`ALTER TABLE "dvd" DROP CONSTRAINT "REL_a68c996998e86e22dc2580918c"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "dvd" ADD CONSTRAINT "REL_a68c996998e86e22dc2580918c" UNIQUE ("stockId")`);
