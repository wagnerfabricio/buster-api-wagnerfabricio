...
export class initialCommit1653857994010 implements MigrationInterface {
  name = "initialCommit1653857994010";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "cart_dvd" ADD CONSTRAINT "FK_ee4cc49ad202a770a3b86f3fcfb" FOREIGN KEY ("cartId") REFERENCES "cart"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
